...
struct QueryApiSecrets{1: i64 userId}
struct ValidateApiSignature{1: string payload, 2: string identifier, 3: string signature} // True or False
...
struct DoDeleteApiSecret{1: i64 userId, 2: string secret}
