 ...
 *
 * This file was auto generated by auto_gen_serializer.sh on Thu Apr 10 12:09:22 CST 2014
 */
...
class ThriftBinarySerializer extends Serializer {
  ...
  lazy val _cApiSecretState = BinaryScalaCodec(ApiSecretState)
  lazy val _cPersistentAccountState = BinaryScalaCodec(PersistentAccountState)
  ...
  def toBinary(obj: AnyRef): Array[Byte] = obj match {
    ...
    case m: ApiSecretState => _cApiSecretState(m)
    case m: PersistentAccountState => _cPersistentAccountState(m)
  ...
  def fromBinary(bytes: Array[Byte],
    ...
    case Some(c) if c == classOf[ApiSecretState.Immutable] => _cApiSecretState.invert(bytes).get
    case Some(c) if c == classOf[PersistentAccountState.Immutable] => _cPersistentAccountState.invert(bytes).get
