...
class ThriftBinarySerializer extends Serializer {
  ...
  lazy val s_30 = BinaryScalaCodec(DoRequestPasswordReset)
  lazy val s_31 = BinaryScalaCodec(RequestPasswordResetFailed)
  lazy val s_32 = BinaryScalaCodec(RequestPasswordResetSucceeded)
  lazy val s_33 = BinaryScalaCodec(DoResetPassword)
  lazy val s_34 = BinaryScalaCodec(ResetPasswordFailed)
  lazy val s_35 = BinaryScalaCodec(ResetPasswordSucceeded)
  lazy val s_36 = BinaryScalaCodec(Login)
  lazy val s_37 = BinaryScalaCodec(LoginFailed)
  lazy val s_38 = BinaryScalaCodec(LoginSucceeded)
  lazy val s_39 = BinaryScalaCodec(ValidatePasswordResetToken)
  lazy val s_40 = BinaryScalaCodec(PasswordResetTokenValidationResult)
  lazy val s_41 = BinaryScalaCodec(DoRequestCashDeposit)
  lazy val s_42 = BinaryScalaCodec(RequestCashDepositFailed)
  lazy val s_43 = BinaryScalaCodec(RequestCashDepositSucceeded)
  lazy val s_44 = BinaryScalaCodec(DoRequestCashWithdrawal)
  lazy val s_45 = BinaryScalaCodec(RequestCashWithdrawalFailed)
  lazy val s_46 = BinaryScalaCodec(RequestCashWithdrawalSucceeded)
  lazy val s_47 = BinaryScalaCodec(AdminConfirmCashDepositFailure)
  lazy val s_48 = BinaryScalaCodec(AdminConfirmCashDepositSuccess)
  lazy val s_49 = BinaryScalaCodec(AdminConfirmCashWithdrawalFailure)
  lazy val s_50 = BinaryScalaCodec(AdminConfirmCashWithdrawalSuccess)
  lazy val s_51 = BinaryScalaCodec(DoSubmitOrder)
  lazy val s_52 = BinaryScalaCodec(SubmitOrderFailed)
  lazy val s_53 = BinaryScalaCodec(OrderFundFrozen)
  lazy val s_54 = BinaryScalaCodec(DoAddNewApiSecret)
  lazy val s_55 = BinaryScalaCodec(DoDeleteApiSecret)
  lazy val s_56 = BinaryScalaCodec(ApiSecretOperationResult)
  lazy val s_57 = BinaryScalaCodec(QueryApiSecrets)
  lazy val s_58 = BinaryScalaCodec(QueryApiSecretsResult)
  lazy val s_59 = BinaryScalaCodec(DoCancelOrder)
  lazy val s_60 = BinaryScalaCodec(CancelOrderFailed)
  lazy val s_61 = BinaryScalaCodec(OrderSubmitted)
  lazy val s_62 = BinaryScalaCodec(OrderCancelled)
  lazy val s_63 = BinaryScalaCodec(DoUpdateMetrics)
  lazy val s_64 = BinaryScalaCodec(DoSendEmail)
  lazy val s_65 = BinaryScalaCodec(QueryAccount)
  lazy val s_66 = BinaryScalaCodec(QueryAccountResult)
  lazy val s_67 = BinaryScalaCodec(QueryMarketDepth)
  lazy val s_68 = BinaryScalaCodec(QueryMarketDepthResult)
  lazy val s_69 = BinaryScalaCodec(QueryCandleData)
  lazy val s_70 = BinaryScalaCodec(QueryCandleDataResult)
  lazy val s_71 = BinaryScalaCodec(QueryOrder)
  lazy val s_72 = BinaryScalaCodec(QueryOrderResult)
  lazy val s_73 = BinaryScalaCodec(QueryTransaction)
  lazy val s_74 = BinaryScalaCodec(QueryTransactionResult)
