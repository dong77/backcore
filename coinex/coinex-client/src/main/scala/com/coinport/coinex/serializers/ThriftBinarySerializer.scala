...
class ThriftJsonSerializer extends Serializer {
  ...
  lazy val s_33 = JsonScalaCodec(PasswordResetTokenValidationResult)
  lazy val s_34 = JsonScalaCodec(PersistentAccountState)
  lazy val s_35 = JsonScalaCodec(QueryAccount)
  lazy val s_36 = JsonScalaCodec(QueryAccountResult)
  lazy val s_37 = JsonScalaCodec(QueryApiSecrets)
  lazy val s_38 = JsonScalaCodec(QueryApiSecretsResult)
  lazy val s_39 = JsonScalaCodec(QueryCandleData)
  lazy val s_40 = JsonScalaCodec(QueryCandleDataResult)
  lazy val s_41 = JsonScalaCodec(QueryMarket)
  lazy val s_42 = JsonScalaCodec(QueryMarketResult)
  lazy val s_43 = JsonScalaCodec(QueryMarketUnsupportedMarketFailure)
  lazy val s_44 = JsonScalaCodec(QueryTransactionData)
  lazy val s_45 = JsonScalaCodec(QueryTransactionDataResult)
  lazy val s_46 = JsonScalaCodec(QueryUserOrders)
  lazy val s_47 = JsonScalaCodec(QueryUserOrdersResult)
  lazy val s_48 = JsonScalaCodec(QueryUserTransaction)
  lazy val s_49 = JsonScalaCodec(QueryUserTransactionResult)
  lazy val s_50 = JsonScalaCodec(RegisterUserFailed)
  lazy val s_51 = JsonScalaCodec(RegisterUserSucceeded)
  lazy val s_52 = JsonScalaCodec(RequestPasswordResetFailed)
  lazy val s_53 = JsonScalaCodec(RequestPasswordResetSucceeded)
  lazy val s_54 = JsonScalaCodec(ResetPasswordFailed)
  lazy val s_55 = JsonScalaCodec(ResetPasswordSucceeded)
  lazy val s_56 = JsonScalaCodec(RobotMetrics)
  lazy val s_57 = JsonScalaCodec(SendMailRequest)
  lazy val s_58 = JsonScalaCodec(Transaction)
  lazy val s_59 = JsonScalaCodec(TransactionData)
  lazy val s_60 = JsonScalaCodec(TransactionItem)
  lazy val s_61 = JsonScalaCodec(UserAccount)
  lazy val s_62 = JsonScalaCodec(UserLogsState)
  lazy val s_63 = JsonScalaCodec(UserProfile)
  lazy val s_64 = JsonScalaCodec(ValidatePasswordResetToken)
