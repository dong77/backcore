...
case class ApiMarketDepthItemM(p: String, pv: Double, a: String, av: Double)

case class ApiMarketDepthM(b: Seq[ApiMarketDepthItemM], a: Seq[ApiMarketDepthItemM])
...
case class ApiTickerM(i: String, c: String, p: String, v: String, g: Double = 0.0, t: Option[String] = None)
...
case class ApiTransferItem(id: String, uid: String, amount: CurrencyObject, status: Int, created: Long, updated: Long, operation: Int, address: String, txid: String, NxtRsString: Option[String])
...
case class ApiV2Transaction(id: String, timestamp: Long, price: Double, amount: Double, maker: String, taker: String, isSell: Boolean, taker_order_id: String, maker_order_id: String, market: Option[String])
