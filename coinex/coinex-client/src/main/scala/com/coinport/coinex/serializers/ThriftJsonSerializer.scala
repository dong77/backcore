 ...
 *
 * This file was auto generated by auto_gen_serializer.sh on Sat Mar 29 15:00:03 CST 2014
 */
...
class ThriftBinarySerializer extends Serializer {
  ...
  lazy val s_33 = BinaryScalaCodec(PasswordResetTokenValidationResult)
  ...
  def toBinary(obj: AnyRef): Array[Byte] = obj match {
    ...
    case m: PasswordResetTokenValidationResult => s_33(m)
  ...
  def fromBinary(bytes: Array[Byte],
    ...
    case Some(c) if c == classOf[PasswordResetTokenValidationResult.Immutable] => s_33.invert(bytes).get
