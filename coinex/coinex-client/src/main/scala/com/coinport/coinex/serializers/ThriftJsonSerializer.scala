 ...
 *
 * This file was auto generated by auto_gen_serializer.sh on Wed Apr 02 10:06:13 CST 2014
 */
...
class ThriftBinarySerializer extends Serializer {
  ...
  lazy val s_21 = BinaryScalaCodec(AdminCommandResult)
  lazy val s_22 = BinaryScalaCodec(DoRegisterUser)
  lazy val s_23 = BinaryScalaCodec(RegisterUserFailed)
  lazy val s_24 = BinaryScalaCodec(RegisterUserSucceeded)
  lazy val s_25 = BinaryScalaCodec(DoRequestPasswordReset)
  lazy val s_26 = BinaryScalaCodec(RequestPasswordResetFailed)
  lazy val s_27 = BinaryScalaCodec(RequestPasswordResetSucceeded)
  lazy val s_28 = BinaryScalaCodec(DoResetPassword)
  lazy val s_29 = BinaryScalaCodec(ResetPasswordFailed)
  lazy val s_30 = BinaryScalaCodec(ResetPasswordSucceeded)
  lazy val s_31 = BinaryScalaCodec(Login)
  lazy val s_32 = BinaryScalaCodec(LoginFailed)
  lazy val s_33 = BinaryScalaCodec(LoginSucceeded)
  lazy val s_34 = BinaryScalaCodec(ValidatePasswordResetToken)
  lazy val s_35 = BinaryScalaCodec(PasswordResetTokenValidationResult)
  lazy val s_36 = BinaryScalaCodec(DoRequestCashDeposit)
  lazy val s_37 = BinaryScalaCodec(RequestCashDepositFailed)
  lazy val s_38 = BinaryScalaCodec(RequestCashDepositSucceeded)
  lazy val s_39 = BinaryScalaCodec(DoRequestCashWithdrawal)
  lazy val s_40 = BinaryScalaCodec(RequestCashWithdrawalFailed)
  lazy val s_41 = BinaryScalaCodec(RequestCashWithdrawalSucceeded)
  lazy val s_42 = BinaryScalaCodec(AdminConfirmCashDepositFailure)
  lazy val s_43 = BinaryScalaCodec(AdminConfirmCashDepositSuccess)
  lazy val s_44 = BinaryScalaCodec(AdminConfirmCashWithdrawalFailure)
  lazy val s_45 = BinaryScalaCodec(AdminConfirmCashWithdrawalSuccess)
  lazy val s_46 = BinaryScalaCodec(DoSubmitOrder)
  lazy val s_47 = BinaryScalaCodec(SubmitOrderFailed)
  lazy val s_48 = BinaryScalaCodec(OrderFundFrozen)
  lazy val s_49 = BinaryScalaCodec(DoAddNewApiSecret)
  lazy val s_50 = BinaryScalaCodec(DoDeleteApiSecret)
  lazy val s_51 = BinaryScalaCodec(ApiSecretOperationResult)
  lazy val s_52 = BinaryScalaCodec(QueryApiSecrets)
  lazy val s_53 = BinaryScalaCodec(QueryApiSecretsResult)
  lazy val s_54 = BinaryScalaCodec(DoCancelOrder)
  lazy val s_55 = BinaryScalaCodec(CancelOrderFailed)
  lazy val s_56 = BinaryScalaCodec(OrderSubmitted)
  lazy val s_57 = BinaryScalaCodec(OrderCancelled)
  lazy val s_58 = BinaryScalaCodec(DoUpdateMetrics)
  lazy val s_59 = BinaryScalaCodec(DoSendEmail)
  lazy val s_60 = BinaryScalaCodec(QueryAccount)
  lazy val s_61 = BinaryScalaCodec(QueryAccountResult)
  lazy val s_62 = BinaryScalaCodec(QueryMarketDepth)
  lazy val s_63 = BinaryScalaCodec(QueryMarketDepthResult)
  lazy val s_64 = BinaryScalaCodec(QueryCandleData)
  lazy val s_65 = BinaryScalaCodec(QueryCandleDataResult)
  lazy val s_66 = BinaryScalaCodec(QueryUserTransaction)
  lazy val s_67 = BinaryScalaCodec(QueryUserTransactionResult)
  lazy val s_68 = BinaryScalaCodec(QueryUserOrders)
  lazy val s_69 = BinaryScalaCodec(QueryUserOrdersResult)
  lazy val s_70 = BinaryScalaCodec(QueryTransactionData)
  lazy val s_71 = BinaryScalaCodec(QueryTransactionDataResult)
  lazy val s_72 = BinaryScalaCodec(QueryOrderData)
  lazy val s_73 = BinaryScalaCodec(QueryOrderDataResult)
