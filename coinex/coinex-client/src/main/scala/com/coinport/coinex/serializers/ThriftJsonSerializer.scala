...
class ThriftJsonSerializer extends Serializer {
  ...
  lazy val _cAddRobotModelFailed = JsonScalaCodec(AddRobotModelFailed)
  lazy val _cAddRobotModelSucceeded = JsonScalaCodec(AddRobotModelSucceeded)
  ...
  lazy val _cDoAddModel = JsonScalaCodec(DoAddModel)
  ...
  lazy val _cDoUpdateModel = JsonScalaCodec(DoUpdateModel)
  ...
  lazy val _cUpdateRobotModelFailed = JsonScalaCodec(UpdateRobotModelFailed)
  lazy val _cUpdateRobotModelSucceeded = JsonScalaCodec(UpdateRobotModelSucceeded)
  ...
  lazy val _cTDepositWithdrawState = JsonScalaCodec(TDepositWithdrawState)
  ...
  lazy val _cTRobotModelState = JsonScalaCodec(TRobotModelState)
