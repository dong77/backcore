...
namespace java com.coinport.coinex.domain
...
struct OrderSubmissionOK{1: Order order,2: list<Transaction> txs}
...
struct DoSubmitOrder{1: Order order}
...
struct OrderSubmitted{1: Order order}

// MarketProcessor -> AccountProcessor events
struct OrderCancelled{1: Order order}
struct TransactionsCreated{1: list<Transaction> txs}
struct NewTxPriceSeen{1: MarketSide marketSide, 2: i64 price}