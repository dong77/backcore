...
class TransferBehaviorSpec extends IntegrationSpec(new Environment) {
  "AccountTransferWithdrawSpec" should {
    ...
    val transferConfig = new AccountTransferConfig(false, Map.empty, Set.empty, Map.empty)
    dw.setSucceededRetainNum(transferConfig.confirmNumMap)
    ...
    "DoRequestTransfer act as expected" in {
      ...
      val deposit = DoRequestTransfer(AccountTransfer(101, 1000000000, Deposit, Btc, 100))
      ...
      val userToHot = DoRequestTransfer(AccountTransfer(102, 1000000000, UserToHot, Btc, 10, address = Some("userAddress")))
      ...
      val withdrawal = DoRequestTransfer(AccountTransfer(103, 1000000000, Withdrawal, Btc, 10))
      ...
      val coldToHot = DoRequestTransfer(AccountTransfer(104, 1000000000, ColdToHot, Btc, 10))
      ...
      val hotToCold = DoRequestTransfer(AccountTransfer(105, 1000000000, HotToCold, Btc, 10))
      ...
      val unknown = DoRequestTransfer(AccountTransfer(106, 1000000000, TransferType.Unknown, Btc, 10))
