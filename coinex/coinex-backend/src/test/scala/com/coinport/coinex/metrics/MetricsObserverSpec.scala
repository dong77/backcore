  ...
  "MetricsObserver" should {
    "normal test" in {
      ...
      observer.getMetrics(1) mustEqual MetricsByMarket(
        MarketSide(Btc, Rmb), 12.5, Some(12.5), Some(12.5), 100, None, Keep)
