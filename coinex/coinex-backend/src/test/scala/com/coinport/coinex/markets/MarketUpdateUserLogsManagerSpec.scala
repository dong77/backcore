...
class MarketUserLogsManagerSpec extends Specification {

  "MarketUserLogsManager" should {
    "change existing order to cancelled state without changing other fields" in {
      ...
      val manager = new MarketUserLogsManager()
      ...
      manager.getOrderInfos(QueryUserOrders(666))(2) mustEqual orderInfo1.copy(outAmount = 55 + 88, inAmount = 111 + 222, lastTxTimestamp = Some(456))
