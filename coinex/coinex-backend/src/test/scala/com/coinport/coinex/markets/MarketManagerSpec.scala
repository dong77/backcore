...
class MarketManagerSpec extends Specification {
  ...
  "MarketManager" should {
    "take limit can't block the current transaction" in {
      ...
      manager.lastOrderId = 100L
      manager.lastTxId = 200L
      ...
      manager.addOrderToMarket(takerSide, taker) mustEqual OrderSubmitted(
        OrderInfo(MarketSide(Btc, Rmb),
          Order(3, 103, 1, Some(2000.0), Some(2000), None, None, None, None, 0, None), 1, 5000, FullyExecuted, Some(0)),
        List(Transaction(201, 0, MarketSide(Btc, Rmb),
          OrderUpdate(
            Order(3, 103, 1, Some(2000.0), Some(2000), None, None, None, None, 0, None),
            Order(3, 103, 0, Some(2000.0), Some(-3000), None, None, None, None, 5000, None)),
          OrderUpdate(
            Order(2, 102, 50000, Some(2.0E-4), None, None, None, None, None, 0, None),
            Order(2, 102, 45000, Some(2.0E-4), None, None, None, None, None, 1, None)), None)))
    }
    ...
    "change the last taker order in tx" in {
      ...
      manager.addOrderToMarket(takerSide, taker) mustEqual OrderSubmitted(
        OrderInfo(MarketSide(Btc, Rmb),
          Order(1, 2, 2200, Some(5.0E-4), None, None, None, None, None, 0, None), 2000, 1, FullyExecuted, Some(0)),
        List(Transaction(1, 0, MarketSide(Btc, Rmb),
          OrderUpdate(
            Order(1, 2, 2200, Some(5.0E-4), None, None, None, None, None, 0, None),
            Order(1, 2, 200, Some(5.0E-4), None, None, None, None, None, 1, Some(Dust))),
          OrderUpdate(
            Order(0, 1, 1, Some(2000.0), None, None, None, None, None, 0, None),
            Order(0, 1, 0, Some(2000.0), None, None, None, None, None, 2000, None)), None)))
    }
    ...
    "fix the dust bug from robot test" in {
      ...
      manager.addOrderToMarket(makerSide, Order(-6771488127296557565L, 32, 21930, Some(1.1499999999999999E-4), None, Some(1397457555749L), None, Some(-6771488127296557565L), None, 0))
      manager.addOrderToMarket(takerSide, Order(-245561917658914311L, 33, 8, Some(4920.0), None, Some(1397457555805L), None, Some(-245561917658914311L), None, 0)) mustEqual
        OrderSubmitted(
          OrderInfo(MarketSide(Btc, Rmb), Order(-245561917658914311L, 102, 8, Some(4920.0), None, Some(1397457555805L), None, Some(-245561917658914311L), None, 0), 2, 17391, PartiallyExecuted, Some(1397457555805L)),
          List(
            Transaction(201, 1397457555805L, MarketSide(Btc, Rmb),
              OrderUpdate(
                Order(-245561917658914311L, 102, 8, Some(4920.0), None, Some(1397457555805L), None, Some(-245561917658914311L), None, 0),
                Order(-245561917658914311L, 102, 6, Some(4920.0), None, Some(1397457555805L), None, Some(-245561917658914311L), None, 17391)),
              OrderUpdate(
                Order(-6771488127296557565L, 101, 21930, Some(1.1499999999999999E-4), None, Some(1397457555749L), None, Some(-6771488127296557565L), None, 0),
                Order(-6771488127296557565L, 101, 4539, Some(1.1499999999999999E-4), None, Some(1397457555749L), None, Some(-6771488127296557565L), None, 2, Some(Dust))), None)))

      manager.orderMap mustEqual Map(102 -> Order(-245561917658914311L, 102, 6, Some(4920.0), None, Some(1397457555805L), None, Some(-245561917658914311L), None, 17391))
      manager.orderPool(makerSide) mustEqual SortedSet.empty[Order]
      manager.orderPool(takerSide) mustEqual SortedSet(Order(-245561917658914311L, 102, 6, Some(4920.0), None, Some(1397457555805L), None, Some(-245561917658914311L), None, 17391))
    }
    ...
    "match limit-price order market-price orders can't exists in the market" in {
      ...
      result mustEqual OrderSubmitted(
        ...
        Seq(
          Transaction(1, 0, takerSide, taker --> taker.copy(quantity = 98, inAmount = 10000), lpo1 --> updatedLpo1),
          Transaction(2, 0, takerSide,
  ...
  "MarketManager" should {
    "match limit-price order against existing limit-price order with take-limit and update take-limit" in {
      ...
      result mustEqual OrderSubmitted(
        ...
        Seq(Transaction(1, 0, takerSide, taker --> updatedTaker, maker --> updatedMaker.copy(refundReason = Some(Dust)))))
    ...
    "match limit-price order with as many existing limit-price order with take-limit" in {
      ...
      result mustEqual OrderSubmitted(
        ...
        Seq(
          Transaction(1, 0, takerSide, taker --> taker.copy(quantity = 7, inAmount = 15000),
            maker2 --> updatedMaker2),
          Transaction(2, 0, takerSide, taker.copy(quantity = 7, inAmount = 15000) --> updatedTaker,
    ...
    "match new market-price taker order against existing limit-price maker orders and fully execute maker orders " +
      "if its quantity is smaller" in {
        ...
        result mustEqual OrderSubmitted(
          ...
          Seq(Transaction(1, 0, takerSide, taker --> updatedTaker.copy(refundReason = Some(AutoCancelled)),
            maker --> updatedMaker)))
  ...
  "MarketManager" should {
    "match new limit-price taker order against the highest limit-price maker order" in {
      ...
      result mustEqual OrderSubmitted(
        ...
        Seq(Transaction(1, 0, takerSide, taker --> updatedTaker, maker2 --> updatedMaker2)))
