...
object CoinexBuild extends Build {
  val coinexVersion = "1.1.9-SNAPSHOT"
  ...
  lazy val backend = Project(
    ...
    .settings(
      libraryDependencies += ("com.coinport" %% "akka-persistence-hbase" % "1.0.2-SNAPSHOT")
      ...
      libraryDependencies ++= Seq(
        ...
        "com.github.scullxbones" % "akka-persistence-mongo-casbah_2.10" % "0.0.4-SNAPSHOT",
        "org.specs2" %% "specs2" % "2.3.8" % "test",
        "org.scalatest" %% "scalatest" % "2.0" % "test",
