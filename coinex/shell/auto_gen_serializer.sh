...
object Generator {
  ...
  def apply() = {
    ...
    generateJson4sSerializerFile("ThriftEnumJson4sSerialization", enums,
      "coinex-client/src/main/scala/com/coinport/coinex/serializers/ThriftEnumJson4sSerialization.scala", time)
  }
  ...
  def generateJson4sSerializerFile(className: String, enums: Seq[String], outputFile: String, time: String) = {
    ...
    val code = ENUM_CODE_TEMPLATE.format(time, className, enumSerializers, enumSerializers2)
